...
def plots(i_list, fun_list, acc_list, C, T, loss_type):
    """
    画图并保存
    """
    ...
    if not os.path.exists('./output'):
        os.makedirs('./output')
    plt.savefig('./output/{}.png'.format(loss_type))
...
if __name__ == '__main__':
    ...
    画图
    '''
    plots(i_list, fun_list, acc_list, C, T, loss_type)
